        ...
        <div class="row">
            <div class="col-md-5 col-sm-5 col-xs-12">
                <div class="teacher-details-img">
                    <img src="img/teacher/teacher18.png" alt="teacher">  
                </div>
            </div>
            <div class="col-md-7 col-sm-7 col-xs-12">
                <div class="teacher-details-content ml-50">
                    <h2>Тыныштықбай Абылай Қанатұлы</h2>
                    <h5>Преподаватель математики</h5>
                    <h4></h4>
                    <p> - Учитель математики в РФМШ</p>
                    <ul>
                        <li><span>Образование: </span>Карагандинский государственный университет  им. академика Е.А.Букетова </li>
