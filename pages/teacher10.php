        ...
        <div class="row">
            <div class="col-md-5 col-sm-5 col-xs-12">
                <div class="teacher-details-img">
                    <img src="img/teacher/teacher10.png" alt="teacher">  
                </div>
            </div>
            <div class="col-md-7 col-sm-7 col-xs-12">
                <div class="teacher-details-content ml-50">
                    <h2>Сандыбаев Ербол Есенәліұлы</h2>
                    <h5></h5>
                    <h4></h4>
                    <p>Преподаватель SAT<br>Преподаватель физики в программе "Подготовка в РФ ВУЗы" </p>
                    <ul>
                        <li><span>Образование: </span>КазНУ магистр теxническиx наук</li>
