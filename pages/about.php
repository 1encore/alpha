        ...
        <div class="row">
            <div class="col-md-6 col-sm-6">
                <div class="about-content">
                    <h2>WELCOME TO <span>ALPHA ACADEMY</span></h2>
                    ...
                    <p class="hidden-sm">Свяжитесь с нами, и мы обсудим, как мы можем вам помочь</p>
                    <a class="default-btn" href="#contact1">СВЯЗАТЬСЯ</a>
                </div>
            </div>
            <div class="col-md-6 col-sm-6">
                <div class="about-img">
        ...
        <div class="row">
            <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="notice-right-wrapper mb-25 pb-25">
                    <h3>ҰЛЫ ДАЛА ЕРІКТКЛЕРІ</h3>
                    <div class="notice-video">
                        <div class="video-icon video-hover">
                            <a class="video-popup" href="https://www.youtube.com/watch?v=SM_YQURZibU">
