        ...
        <div class="row">
            <div class="col-md-5 col-sm-5 col-xs-12">
                <div class="teacher-details-img">
                    <img src="img/teacher/teacher12.png" alt="teacher">  
                </div>
            </div>
            <div class="col-md-7 col-sm-7 col-xs-12">
                <div class="teacher-details-content ml-50">
                    <h2>Шокпарбаева Аруна Максатызы</h2>
                    <h5>Преподаватель английского языка</h5>
                    <h4>Обо мне</h4>
                    <p>-exchange student in Poland <br>-work and travel participant </p>
                    <ul>
                        <li><span>Образование: </span>Satbayev University (Бывш. КазНИТУ Им. Сатпаева)</li>
                        <li><span>Опыт работы: </span>3 годa</li>
