        ...
        <div class="row">
            <div class="col-md-5 col-sm-5 col-xs-12">
                <div class="teacher-details-img">
                    <img src="img/teacher/teacher17.png" alt="teacher">  
                </div>
            </div>
            <div class="col-md-7 col-sm-7 col-xs-12">
                <div class="teacher-details-content ml-50">
                    <h2>Альдикенов Ерген</h2>
                    <h5>Учитель Английского языка и IELTS tutor </h5>
                    <ul>
                        <li><span>Образование: </span>КазУМОиМЯ им. Абылайхана, два иностранных языка.</li>
                        <li><span>Опыт работы: </span>2 года</li>
                        <li><span>Oснователь туристического школьного клуба "Qonaq" </span></li>
