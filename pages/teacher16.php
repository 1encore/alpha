        ...
        <div class="row">
            <div class="col-md-5 col-sm-5 col-xs-12">
                <div class="teacher-details-img">
                    <img src="img/teacher/teacher16.png" alt="teacher">  
                </div>
            </div>
            <div class="col-md-7 col-sm-7 col-xs-12">
                <div class="teacher-details-content ml-50">
                    <h2>Мереке Əділхан Ақжанұлы</h2>
                    <h5>Учитель макроэкономики </h5>
                    <ul>
                        <li><span>Образование: </span>Кбту, факультет мшэ</li>
                        <li><span>Опыт работы: </span>1 года</li>
